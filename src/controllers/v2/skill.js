...
const { selectAllSkills, selectWorkerSkills, selectWorkerSkill, selectSkillName, selectWorkerSkillName, insertWorkerSkill, deleteWorkerSkill } = require("../../models/v1/skill");
